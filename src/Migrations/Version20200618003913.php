 ...
 */
final class Version20200618003913 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE carts ADD details JSON DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL');
