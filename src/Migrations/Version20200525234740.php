 ...
 */
final class Version20200525234740 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE setting (id INT AUTO_INCREMENT NOT NULL, var VARCHAR(180) NOT NULL, display_name VARCHAR(180) NOT NULL, type SMALLINT NOT NULL, value LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
