 ...
 */
final class Version20200617145915 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE love (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, love TINYINT(1) NOT NULL, INDEX IDX_5782501D4584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE love_user (love_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_9480FEBECBB24A1C (love_id), INDEX IDX_9480FEBEA76ED395 (user_id), PRIMARY KEY(love_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
