 ...
 */
final class Version20200618231032 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE orders ADD details LONGTEXT DEFAULT NULL, DROP quantity, CHANGE user_id user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE orders ADD quantity INT NOT NULL, DROP details, CHANGE user_id user_id INT DEFAULT NULL');
